...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AdminBundle:Cliente:index.html.twig', array(
            'clientes' => $clientes,
        ));
    }
    ...
    public function showAction($cpf)
    {
        //var_dump($cpf); die();
        $em = $this->getDoctrine()->getManager();
        $cliente = $em->getRepository('AdminBundle:Cliente')->findOneBy(array('cpf' => $cpf));
        
        
        return $this->render('AdminBundle:Cliente:show.html.twig', array(
            'cliente' => $cliente,
